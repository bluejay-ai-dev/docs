...
1. **Instrument your agent** to export OTLP traces to Bluejay — see [Sending Traces to Bluejay](/key-concepts/traces/overview).
...
<CardGroup cols={2}>
  ...
  <Card title="Sending Traces to Bluejay" icon="route" href="/key-concepts/traces/overview">
