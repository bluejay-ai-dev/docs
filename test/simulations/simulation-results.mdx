...
If a Digital Human has [personalities](/key-concepts/digital-humans/personalities), its conversations are grouped into one row with a badge counting them. Expand the row to compare the base run against each personality, and open a conversation to see the personality it ran as in the side panel's **Digital Human** tab.
