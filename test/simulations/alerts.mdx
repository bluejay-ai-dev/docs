...
To kick off an automated flow when the alert fires, subscribe a URL under [Settings → Webhooks](/key-concepts/webhooks/overview) to **Simulation alert triggered**.
