...
### 1. Get Your Miro API Key

1. Go to the **Miro Development Platform** at [https://developers.miro.com](https://developers.miro.com)
...
7. **Copy the OAuth token** - this is your Miro API key

### 2. Configure Bluejay Integration
