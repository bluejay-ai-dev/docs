...
<video
  ...
  src="https://okihfrlvyycxyylukqey.supabase.co/storage/v1/object/public/bluejay-docs-files/miro-integration-tutorial.mp4"
></video>
...
![Integrations page](/images/miro-integrations.png)
  ...
  <Step title="Import Your Miro Board">
    With the key saved, Bluejay can read your Miro boards and turn a board of connected nodes into a scenario graph. Import your board from the **Scenario Builder** when creating a new scenario, then review the imported paths on the canvas.
