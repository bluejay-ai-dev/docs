...
1. Open the Bluejay agent → **Agent Settings** → **Observability Settings** tab
2. Confirm **Voice AI Provider** is set to **Retell**
3. Toggle **"Auto-start outbound call"** ON
4. Save

{/* SCREENSHOT — Observability Settings with Auto-start toggle ON and Voice AI Provider = Retell. */}
...
| Problem | Cause | Fix |
|---|---|---|
| Simulation queues but no call is placed | Auto-start toggle is off | Toggle it on in agent's Advanced Settings |
...
<CardGroup cols={2}>
  ...
  <Card title="Digital Humans" icon="user" href="/key-concepts/digital-humans">
