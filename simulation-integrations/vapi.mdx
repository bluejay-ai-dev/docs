...
|---|---|
| An assistant that answers calls (**inbound**) | The setup below. Bluejay connects through Vapi's web-call bridge, no phone number needed |
| An assistant that places calls (**outbound**) | See [Testing outbound Vapi assistants](#testing-outbound-vapi-assistants) at the bottom |
