...
1. Open a synced agent and click **Create Simulation**.
...
| Outbound is greyed out | Vapi simulations are inbound-only | Use a different connection type (SIP, LiveKit, Phone) for outbound |
