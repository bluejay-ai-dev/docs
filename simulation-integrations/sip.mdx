...
For a complete build of an OpenAI Realtime agent behind a Twilio SIP domain, with tool calls and traces reported back, see [OpenAI Realtime over Twilio SIP](/simulation-integrations/twilio-openai-realtime).
