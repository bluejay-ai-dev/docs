...
Create a simulation and queue runs as usual — see [Simulations](/test/simulations/overview). Each call independently fetches its own destination from your webhook.
