...
| start_time_utc | string | yes | When the conversation started, in UTC |
| participants | array[object] | yes | List of conversation participants |
| status | string (enum: INITIALIZING, QUEUED, EVALUATING, COMPLETED, INCOMPLETED) | yes | Enum representing the possible states of a conversation. |
