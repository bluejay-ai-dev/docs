...
| **Variant: `observability_alert_triggered`** | | | |
| alert_id | string | yes | The ID of the alert |
| alert_name | string | yes | The name of the alert |
| subtype | string | yes | `triggered` or `recovered` |
| **Variant: `simulation_alert_triggered`** | | | |
| alert_id | string | yes | The ID of the alert |
| alert_name | string | yes | The name of the alert |
| subtype | string | yes | `triggered` or `recovered` |
| simulation_run_id | integer | no | The simulation run that crossed the threshold |
...
**When `type` = `observability_alert_triggered`:**
```json
{
...
**When `type` = `simulation_alert_triggered`:**
```json
{
