...
Review the full parameter list at https://docs.getbluejay.ai/api-reference/endpoint/queue-sms-simulation-run and include any optional parameters (e.g., `agent_version_id`, `knowledge_base_id`, `digital_human_ids`, `terminate_overlapping_simulations`) that serve your integration's use case and align with Bluejay's testing and monitoring capabilities.
