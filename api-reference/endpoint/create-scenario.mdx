...
description: 'Create a scenario definition as a React Flow graph.'
openapi: 'POST /v1/scenario'
---
...
Review the full parameter list at https://docs.getbluejay.ai/api-reference/endpoint/create-scenario and include any optional parameters (e.g., `agent_ids`, `description`) that serve your integration's use case and align with Bluejay's testing and monitoring capabilities.
...
Refer to the full schema at https://docs.getbluejay.ai/api-reference/endpoint/create-scenario. Include optional fields that serve the goal of setting up for testing and monitoring on Bluejay.
...
def create_scenario(payload: dict, api_key: str) -> dict:
...
This endpoint creates a scenario definition for your organization. Provide a name, optional description, optional agent links, and a React Flow–style graph with `nodes`, `edges`, and optional `viewport`.
