...
For **conversation-path** scenarios (React Flow for simulations), use [Create scenario](/api-reference/endpoint/create-scenario) (`POST /v1/scenario`) and the [Scenario Builder cookbook](/cookbook/scenario-builder).
