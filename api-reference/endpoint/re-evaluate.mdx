...
## Reevaluate — POST /v1/re-evaluate/{conversation_id}

> **What this endpoint does:** Re-evaluate a call.

**Endpoint:** POST `https://api.getbluejay.ai/v1/re-evaluate/{conversation_id}`
...
def reevaluate(call_id: str, api_key: str) -> dict:
    url = f"https://api.getbluejay.ai/v1/re-evaluate/{conversation_id}"
