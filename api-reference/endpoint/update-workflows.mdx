...
For **conversation-path** scenarios, use [Update scenario](/api-reference/endpoint/update-scenario) (`PUT /v1/scenario/{workflow_id}`) with the React Flow graph format.
