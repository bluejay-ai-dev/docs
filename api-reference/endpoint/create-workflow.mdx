...
Review the full parameter list at https://docs.getbluejay.ai/api-reference/endpoint/create-workflow and include any optional parameters (e.g., `agent_ids`, `enabled_for_evaluation`) that serve your integration's use case and align with Bluejay's testing and monitoring capabilities.
