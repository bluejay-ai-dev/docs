...
<Steps>
  ...
  <Step title="Review Results" titleSize="h3">
    List production conversations with `GET /v1/observability/conversations` to inspect scores, latency, and per-metric results. `GET /v1/retrieve-call-logs/{agent_id}` is deprecated.
  </Step>
</Steps>
