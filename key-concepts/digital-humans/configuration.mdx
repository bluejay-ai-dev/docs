...
<Tip>
To run every digital human under several of these settings at once — English and Spanish, clean line and traffic noise — add [personalities](/key-concepts/digital-humans/personalities) to the simulation run. These settings stay the caller's own; a personality overrides only the fields it sets.
</Tip>
