...
<AccordionGroup>
  <Accordion title="Language" icon="language">
    The language the Digital Human speaks. Examples: English, Spanish, Mandarin, Hindi, French.
  </Accordion>
  <Accordion title="Accent" icon="globe">
    Regional accent applied to speech. Examples: British, Southern US, Latin American, Australian.
  </Accordion>
  <Accordion title="Speaking Speed" icon="gauge">
    How fast or slow the Digital Human talks. Examples: Slow, Normal, Fast.
  </Accordion>
  <Accordion title="Emotion" icon="face-smile">
    The emotional tone of the conversation. Examples: Calm, Frustrated, Anxious, Cheerful, Angry.
  </Accordion>
  <Accordion title="Volume" icon="volume-high">
    How loudly the Digital Human speaks. Examples: Quiet, Normal, Loud.
  </Accordion>
  <Accordion title="Background Noise" icon="waveform">
    Ambient sounds during the conversation. Examples: Office, Street, Airport, Car, None.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Prompting Guide" icon="pen-fancy" href="/key-concepts/digital-humans/prompting-guide">
    Write intents and success criteria that pair cleanly with these settings.
  </Card>
  ...
  <Card title="Deep Dive" icon="book" href="/core-concepts/digital-humans">
    Full field reference, including silence tool and end-call tool flags.
  </Card>
