...
<CardGroup cols={2}>
  <Card title="Determinism" icon="crosshairs" href="/key-concepts/digital-humans/determinism">
    Which field owns which behavior, and the configs that validate but never fire.
  </Card>
