...
<Tip>
To run the same test case under several of these settings at once — English and Spanish, clean line and traffic noise — give the Digital Human [personalities](/key-concepts/digital-humans/personalities) instead of copying it.
</Tip>
