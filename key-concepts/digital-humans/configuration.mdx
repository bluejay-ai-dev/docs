...
Every Digital Human needs a clear intent and success criteria to produce meaningful test results — **except** when the test case is **workflow-tagged** or driven by **enriched playback** (description and success criteria may be cleared or constrained). See [Workflow tags & enriched playback](/key-concepts/digital-humans/workflow-and-enriched-playback).
