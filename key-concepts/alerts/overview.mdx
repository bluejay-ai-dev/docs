...
- **Channel routing** -- send alerts to specific Slack channels so the right team gets the right signal, or subscribe a URL under Settings → Webhooks to kick off an automated flow when an observability or simulation alert fires
