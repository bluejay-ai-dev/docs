...
An uptime monitor calls or texts one of your live agents on a fixed interval, grades what happened, and records UP or DOWN. When the verdict flips, it notifies Slack, email, PagerDuty, or Better Stack.
