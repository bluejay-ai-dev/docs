...
When rolling out a new agent version or model change, compare metric scores between the old and new variants. Observability dashboards let you filter by metadata fields like `prompt_version` or `experiment_group` to see side-by-side performance.
