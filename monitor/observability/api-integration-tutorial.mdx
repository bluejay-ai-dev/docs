...
<Steps>
  ...
  <Step title="Receive and review results">
    Results arrive via your configured [events webhook](/api-reference/webhook/events-webhook) or by polling `GET /v1/observability/conversations/{conversation_id}`. The [retrieve-call-log](/api-reference/endpoint/retrieve-call-log) route is deprecated.
  </Step>
</Steps>
