...
3. In the **Google Agents** section, paste the contents of the JSON key file.
4. Click **Save**.

<Note>
The key is **encrypted at rest** in Bluejay and only ever used to call the Dialogflow APIs for your
agents. Want keyless auth (Workload Identity Federation) instead? It's an infra-side setup rather
than self-serve — reach out to your Bluejay contact.
</Note>
