...
<Update label="September 9th, 2026" tags={["Improvement", "API"]}>
  ...
  **Same as before:** `POST /v1/evaluate` and `/evaluate-call`. New optional integer `version`. `label` still works. An unknown version returns 404. An unknown label is created.
