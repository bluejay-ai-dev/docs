...
<Update label="September 1st, 2026" tags={["New", "Integrations"]}>
  ...
  Alerts and uptime monitors can now page through Better Stack alongside PagerDuty. Paste a Better Stack incoming webhook URL under Settings → Integrations, then switch on Better Stack Notifications on any alert or monitor. DOWN opens an incident and recovery resolves it.
